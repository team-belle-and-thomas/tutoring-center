  ...
  return (
    <main className='min-h-screen bg-background'>
      <div className='max-w-4xl mx-auto px-6 py-12'>
        ...
        <div className='mb-12'>
          <h1 className='font-serif text-4xl md:text-5xl font-extrabold text-primary mb-6'>About Momentum Learning</h1>
          <p className='text-xl text-muted-foreground'>Where Learning Becomes Art</p>
        </div>
        ...
        <div className='prose prose-lg max-w-none space-y-8'>
          ...
          <section className='mb-10'>
            <h2 className='font-serif text-2xl font-bold text-primary mb-4'>Why Choose Us</h2>
          ...
          <section className='mb-10'>
            <h2 className='font-serif text-2xl font-bold text-primary mb-4'>Did You Know?</h2>
            <div className='grid md:grid-cols-2 gap-6'>
              <div className='bg-card p-6 rounded-2xl shadow-sm border'>
                <p className='text-sm text-muted-foreground uppercase tracking-wide mb-2'>Founded</p>
                <p className='font-serif text-3xl font-bold text-primary'>2019</p>
              </div>
              <div className='bg-card p-6 rounded-2xl shadow-sm border'>
                <p className='text-sm text-muted-foreground uppercase tracking-wide mb-2'>Students Helped</p>
                <p className='font-serif text-3xl font-bold text-primary'>2,500+</p>
              </div>
              <div className='bg-card p-6 rounded-2xl shadow-sm border'>
                <p className='text-sm text-muted-foreground uppercase tracking-wide mb-2'>Tutor Network</p>
                <p className='font-serif text-3xl font-bold text-primary'>150+</p>
              </div>
              <div className='bg-card p-6 rounded-2xl shadow-sm border'>
                <p className='text-sm text-muted-foreground uppercase tracking-wide mb-2'>Satisfaction Rate</p>
          ...
          <section className='mb-10'>
            <h2 className='font-serif text-2xl font-bold text-primary mb-4'>Our Approach</h2>
          ...
          <section className='text-center pt-8 border-t'>
            <h2 className='font-serif text-2xl font-bold text-primary mb-4'>Ready to Start Your Journey?</h2>
            <Button asChild className='text-xl font-bold py-6 px-8' size='lg'>
