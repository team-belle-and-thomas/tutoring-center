  ...
  return (
    <main className='pl-6 md:pl-20 pt-10 pr-6 md:pr-20 select-none'>
      <div className='header mb-12 md:mb-16 border-b border-b-gray-400 flex items-center justify-between'>
        <h3 className='font-serif text-2xl uppercase text-primary tracking-widest font-extrabold'>Momentum Learning</h3>
        <Link
          href='/about'
      ...
      <div className='flex flex-col lg:flex-row gap-12 lg:gap-20 items-start'>
        <div className='hero w-full lg:w-1/2 flex flex-col gap-y-8'>
          <div className='border-3 bg-primary border-primary w-1/10' />
          <h1 className='font-serif text-4xl md:text-6xl lg:text-5xl xl:text-[4.5rem] leading-tight font-extrabold wrap-break-word'>
          ...
          <Button asChild className='text-2xl w-fit font-bold py-8 px-10' size='lg'>
